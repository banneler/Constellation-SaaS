...
const jarvisData = {
    ...
    'contacts.html': [
        ...
        { container: '.contact-details-form-card', macro: 'Contact Record. Edit fields, public profile URL, and ZoomInfo or Salesforce enrichment.', nodes: [{ anchor: '#contact-profile-url', text: 'Save a public profile URL for this contact.' }, { anchor: '#contact-profile-url-link', text: 'Open the public profile in a new tab.' }, { anchor: '#zoominfo-contact-btn', text: 'Look up contact in ZoomInfo.' }, { anchor: 'form#contact-form button[type="submit"]', text: 'Save contact changes.' }, { anchor: '#delete-contact-btn', text: 'Delete this contact.' }] },
    ...
    'pathfinder.html': [
        { container: '.pathfinder-shell', macro: 'Pathfinder Contact Discovery. Review evidence-backed technology and network contacts before they become CRM records.', nodes: [
            { anchor: '#pathfinder-refresh-btn', text: 'Refresh discovered candidates.' },
            { anchor: '#pathfinder-account-filter', text: 'Filter candidates by account.' },
            { anchor: '#pathfinder-status-filter', text: 'Filter by review status.' },
            { anchor: '#pathfinder-role-filter', text: 'Filter by technology or network role family.' },
            { anchor: '.pathfinder-evidence-btn', text: 'Open source evidence for this candidate.' },
            { anchor: '.pathfinder-review-btn', text: 'Review and approve this candidate into Contacts.' }
        ] }
    ],
    'accounts.html': [
        ...
        { container: '.account-contacts-card', macro: 'Account Contacts. List or org chart view of associated contacts, plus Pathfinder discovery.', nodes: [{ anchor: '#pathfinder-pending-link', text: 'Review pending Pathfinder candidates for this account.' }, { anchor: '#pathfinder-account-btn', text: 'Queue a Pathfinder scan for this account.' }, { anchor: '#contact-list-btn', text: 'View contacts as list.' }, { anchor: '#contact-org-chart-btn', text: 'View contacts as org chart.' }, { anchor: '#org-chart-maximize-btn', text: 'Expand org chart in modal.' }] },
